...
class MergePtSsIsInFolders(object):
    ...
    def merge(self):
        ...
        semantic_segmentation_files = [
            file for file in segmented_data_files if "semantic_segmentation_" in file
        ]
        ...
        semantic_segmentation = {
            ...
            .split(".")[0]
            .replace("semantic_segmentation_", ""): file
        ...
        instance_segmentation_files = [
            file for file in segmented_data_files if "instance_segmentation_" in file
        ]
        ...
        instance_segmentation = {
            os.path.basename(file)
            .split(".")[0]
            .replace("instance_segmentation_", ""): file
        ...
        for item in tqdm(list_of_matched_tupeles):
            MergePtSsIs(
                ...
                output_file_path=os.path.join(
                    ...
                    os.path.basename(item[0]).split(".")[0] + ".las",
                ),
