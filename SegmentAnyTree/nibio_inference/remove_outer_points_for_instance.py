...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Remove points outside of the instance bounding box."
    )
    ...
    for las_file in las_files:
        ...
        remove_outer_points_for_instance(
            os.path.join(args.input_folder, las_file),
            os.path.join(args.output_folder, las_file),
        )
