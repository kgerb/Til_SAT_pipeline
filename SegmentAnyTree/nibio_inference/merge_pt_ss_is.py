...
class MergePtSsIs(object):
    ...
    def merge(self):
        ...
        semantic_segmentation_dd = dd.from_pandas(
            semantic_segmentation_df, npartitions=48
        )
        instance_segmentation_dd = dd.from_pandas(
            instance_segmentation_df, npartitions=48
        )
