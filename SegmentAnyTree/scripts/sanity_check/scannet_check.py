    ...
    for scene in scene_list:
        ...
        if check_aggregation_json and check_gt and check_seg and check_ply:
            ...
            if not check_aggregation_json:
                download_link = (
                    base_url + "/" + scene_raw + "/" + scene_raw + ".aggregation.json"
                )
            ...
            if not check_ply:
                download_link = (
                    base_url + "/" + scene_raw + "/" + scene_raw + "_vh_clean_2.ply"
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--base_dir",
        type=str,
        default="../data/scannet-sparse/raw/scans/",
        help="dataset sequence base directory",
    )
    parser.add_argument(
        "--version", type=str, default="v2", help="version of scanNet, (default is v2)"
    )
