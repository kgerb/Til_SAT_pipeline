...
class ModelInference(object):
    ...
    def __init__(
        ...
        checkpoint = model_checkpoint.ModelCheckpoint(
            checkpoint_dir, model_name, weight_name, strict=True
        )
        if mock_dataset:
...
class PointNetForward(ModelInference):
    ...
    def __init__(
        ...
        self.inference_transform = BaseDataset.remove_transform(
            self.inference_transform, [GridSampling3D, FixedPoints]
        )
