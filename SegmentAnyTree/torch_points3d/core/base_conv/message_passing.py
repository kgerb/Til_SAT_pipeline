...
class BaseConvolutionDown(BaseConvolution):
    def __init__(self, sampler, neighbour_finder, *args, **kwargs):
        super(BaseConvolutionDown, self).__init__(
    ...
    def forward(self, data, **kwargs):
        ...
        row, col = self.neighbour_finder(
            pos, pos[idx], batch_x=batch, batch_y=batch[idx]
        )
...
class BaseMSConvolutionDown(BaseConvolution):
    ...
    def __init__(
        ...
        super(BaseMSConvolutionDown, self).__init__(
            sampler, neighbour_finder, *args, **kwargs
        )
...
class BaseResnetBlockDown(BaseConvolutionDown):
    def __init__(self, sampler, neighbour_finder, *args, **kwargs):
        super(BaseResnetBlockDown, self).__init__(
            sampler, neighbour_finder, *args, **kwargs
        )
