...
class TestPairTUM(BasePCRBTest):
    DATASETS = [
        [
            ...
            "https://drive.google.com/uc?id=1Uy9aUyZbjW26-lZ1oyqOUxJ9tP7E-fWP",
        ],
        [
            "pioneer_slam",
            "https://drive.google.com/uc?id=1ha3rxXewWrlCv6SPbpg21I8Wpl9v9fi1",
        ],
        [
            "pioneer_slam3",
            "https://drive.google.com/uc?id=1L8FzuFf1Nc3hy6YfhHYM3qSUKmP_eMBG",
        ],
    ]
    ...
    def __init__(
        ...
        self.link_pairs = (
            "https://cloud.mines-paristech.fr/index.php/s/yjd20Ih9ExqLlHM/download"
        )
...
class TUMDataset(BaseSiameseDataset):
    ...
    def __init__(self, dataset_opt):
        ...
        self.train_dataset = TestPairTUM(
