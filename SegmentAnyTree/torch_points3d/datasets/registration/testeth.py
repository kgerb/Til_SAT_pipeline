    ...
    for filename in os.listdir(folder_name):
        ...
        if matched_string:
            ...
            with open(full_filename) as csv_cloud:
                ...
                line = 0
                out_filename = (
                    folder_name + "/" + "PointCloud" + matched_string.group(1) + ".pcd"
                )
...
class TestPairETH(BasePCRBTest):
    DATASETS = [
        [
            "apartment",
            "http://robotics.ethz.ch/~asl-datasets/apartment_03-Dec-2011-18_13_33/csv_global/global_frame.zip",
        ],
        [
            "hauptgebaude",
            "http://robotics.ethz.ch/~asl-datasets/ETH_hauptgebaude_23-Aug-2011-18_43_49/csv_global/global_frame.zip",
        ],
        [
            "stairs",
            "http://robotics.ethz.ch/~asl-datasets/stairs_26-Aug-2011-14_26_14/csv_global/global_frame.zip",
        ],
        [
            "plain",
            "http://robotics.ethz.ch/~asl-datasets/plain_01-Sep-2011-16_39_18/csv_global/global_frame.zip",
        ],
        [
            "gazebo_summer",
            "http://robotics.ethz.ch/~asl-datasets/gazebo_summer_04-Aug-2011-16_13_22/csv_global/global_frame.zip",
        ],
        [
            "gazebo_winter",
            "http://robotics.ethz.ch/~asl-datasets/gazebo_winter_18-Jan-2012-16_10_04/csv_global/global_frame.zip",
        ],
        [
            "wood_summer",
            "http://robotics.ethz.ch/~asl-datasets/wood_summer_25-Aug-2011-13_00_30/csv_global/global_frame.zip",
        ],
        [
            "wood_autumn",
            "http://robotics.ethz.ch/~asl-datasets/wood_autumn_09-Dec-2011-15_44_05/csv_global/global_frame.zip",
        ],
    ]
    ...
    def __init__(
        ...
        self.link_pairs = (
            "https://cloud.mines-paristech.fr/index.php/s/aIRBieRybts3kEs/download"
        )
        self.link_pose = (
            "https://cloud.mines-paristech.fr/index.php/s/U0F6CFKDCtXcAl7/download"
        )
        BasePCRBTest.__init__(
            self,
            root=root,
            transform=transform,
...
class ETHDataset(BaseSiameseDataset):
    ...
    def __init__(self, dataset_opt):
        ...
        self.train_dataset = TestPairETH(
...
class TestPairETH2(Base3DMatchTest, GeneralFragment):
    ...
    def __init__(
        ...
        self.name = "eth2"
        self.url = (
            "https://cloud.mines-paristech.fr/index.php/s/SuoVN4detclRoE6/download"
        )
